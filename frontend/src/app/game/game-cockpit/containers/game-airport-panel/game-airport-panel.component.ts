...
@UntilDestroy()
@Component({
  selector: 'pg-game-airport-panel',
  templateUrl: './game-airport-panel.component.html',
  styleUrls: ['game-airport-panel.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class GameAirportPanelComponent implements OnInit {
